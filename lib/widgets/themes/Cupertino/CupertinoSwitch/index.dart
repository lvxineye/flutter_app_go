...
import 'package:flutter_app_go/components/widget_demo.dart';
...
class Demo extends StatefulWidget {
  static const String routeName = '/element/themes/Cupertino/CupertinoSwitch';
...
class _DemoState extends State<Demo> {
  ...
  Widget build(BuildContext context) {
    return WidgetDemo(
      ...
      contentList: [Text0, CupertinoSwitchDemo()],
    );
  }
}
